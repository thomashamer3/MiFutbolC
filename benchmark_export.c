...
int main(void)
{
    ...
    ExportBench benchmarks[] =
    {
        ...
        {"Estadisticas por anio",   exportar_estadisticas_por_anio_all,   1, "partido"},
        {"Estadisticas generales",  exportar_estadisticas_generales_all,  1, "partido"},
        {"Estadisticas por mes",    exportar_estadisticas_por_mes_all,    1, "partido"},
    ...
    for (int i = 0; i < n; i++)
    {
        if (benchmarks[i].skip_if_empty && !has_records(benchmarks[i].check_table))
        {
