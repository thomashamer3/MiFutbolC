...
void menu_estadisticas(void)
{
    ...
    MenuItem items[] = {{1, "Generales", &menu_estadisticas_generales},
...
{
    MenuItem items[] = {{1, "Generales", &mostrar_estadisticas_generales},
...
void menu_estadisticas_rendimiento(void)
{
    MenuItem items[] =
    {
        ...
        {
            9, "Caida de Rendimiento por Cansancio Acumulado",
            &mostrar_caida_rendimiento_cansancio_acumulado
        },
