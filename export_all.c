...
static void exportar_todo_md() {
  ...
  md_exportar_tabla(
      ...
      "DESC LIMIT 100",
      (const char *[]){"ID", "Fecha", "Goles", "Asist", "Result", "Cancha",
                       "Camiseta"},
      7);
