...
void equipamiento_historial_crear(void)
{
    ...
    sqlite3_bind_text(stmt, 3, marca[0] ? marca : "", -1, SQLITE_TRANSIENT);
    sqlite3_bind_text(stmt, 4, modelo[0] ? modelo : "", -1, SQLITE_TRANSIENT);
    sqlite3_bind_text(stmt, 5, fecha_compra[0] ? fecha_compra : "", -1, SQLITE_TRANSIENT);
    sqlite3_bind_double(stmt, 6, precio);
    sqlite3_bind_int(stmt, 7, estado);
    sqlite3_bind_int(stmt, 8, rating);
    sqlite3_bind_text(stmt, 9, notas[0] ? notas : "", -1, SQLITE_TRANSIENT);
...
void equipamiento_historial_editar(void)
{
    ...
    sqlite3_bind_text(stmt, 2, modelo, -1, SQLITE_TRANSIENT);
    ...
    sqlite3_bind_text(stmt, 8, notas, -1, SQLITE_TRANSIENT);
