...
int menu_get_item_count(void) { return (int)MENU_ITEM_COUNT; }

const MenuItem *menu_get_items(void) { return (const MenuItem *)MENU_ITEMS; }
...
MenuItem *create_filtered_menu(int *count) {
  ...
  *count = (int)MENU_ITEM_COUNT;
  ...
  const char *(*getters[])(void) = {
      ...
      &get_menu_recordatorios,  &get_menu_colecciones,  &get_menu_settings,
      &get_menu_musica,         &get_menu_exit};
