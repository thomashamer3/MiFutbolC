...
void crear_partido()
{
    ...
    cancha_id = input_int("ID Cancha: ");
    if (!existe_id("cancha", cancha_id))
        return;

    goles = input_int("Goles: ");
    asistencias = input_int("Asistencias: ");
    printf("Resultado (1=VICTORIA, 2=EMPATE, 3=DERROTA): ");
    resultado = input_int("Resultado: ");
    while (resultado < 1 || resultado > 3)
    {
        printf("Resultado inválido. Ingrese 1, 2 o 3: ");
        resultado = input_int("Resultado: ");
    }
    listar_camisetas();
    ...
    {
        printf("Rendimiento inválido. Ingrese entre 1 y 10: ");
        rendimiento_general = input_int("Rendimiento general (1-10): ");
    }
    ...
    {
        printf("Cansancio inválido. Ingrese entre 1 y 10: ");
        cansancio = input_int("Cansancio (1-10): ");
    }
    ...
    {
        printf("Estado de Animo inválido. Ingrese entre 1 y 10: ");
        estado_animo = input_int("Estado de Animo (1-10): ");
    }
    ...
    {
        printf("Clima inválido. Ingrese entre 1 y 6: ");
        clima = input_int("Clima (1=Despejado, 2=Nublado, 3=Lluvia, 4=Ventoso, 5=Mucho Calor, 6=Mucho Frio):");
    }
    ...
    while (dia < 1 || dia > 3)
    {
        printf("Dia inválido. Ingrese 1, 2 o 3: ");
        dia = input_int("Dia (1=Dia, 2=Tarde, 3=Noche): ");
    }
