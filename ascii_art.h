/**
 * @file ascii_art.h
 * @brief Colección de artes ASCII y funciones de visualización gráfica para
 * MiFutbolC
 *
 * Proporciona un conjunto de constantes y funciones para mejorar la interfaz
 * visual de la aplicación mediante el uso de arte ASCII y animaciones sencillas
 * en consola.
 */
...
#define ASCII_BIENVENIDA                                                                           \
    ".___  ___.  __   _______  __    __  .___________..______     ______    __ "                   \
    "       ______ \n"                                                                             \
    "|   \\/   | |  | |   ____||  |  |  | |           ||   _  \\   /  __  \\  "                    \
    "|  |      /      |\n"                                                                         \
    "|  \\  /  | |  | |  |__   |  |  |  | `---|  |----`|  |_)  | |  |  |  | |  "                   \
...
#define ASCII_FINANCIAMIENTO                                                                       \
    ...
    " |  _| | | | | | (_| | | | | (__| | (_| | | | | | | |  __/ | | | || (_) "                     \
    "|\n"                                                                                          \
    " |_|   |_|_| |_|\\__,_|_| |_|\\___|_|\\__,_|_| |_| |_|_|\\___|_| "                            \
    "|_|\\__|\\___/ \n"
...
#define ASCII_RECORDATORIOS                                                                        \
    ...
    " |  _ <  __/ (_| (_) | | | (_| | (_| | || (_) | |  | | (_) \\__ \\\n"                         \
    " |_| \\_\\___|\\___\\___/|_|  \\__,_|\\__,_|\\__\\___/|_|  "                                  \
    "|_|\\___/|___/\n"
...
#define ASCII_ENTRENADOR_IA                                                                        \
    ...
    " \n"                                                                                          \
    " | |___| | | | |_| | |  __/ | | | (_| | (_| | (_) | |     | | / ___ \\ \n"                    \
    " |_____|_| |_|\\__|_|  \\___|_| |_|\\__,_|\\__,_|\\___/|_|    |___/_/   "                     \
    "\\_\\\n"
/**
 * @brief Genera una representación visual de una cancha de fútbol animada en
 * consola
 *
...
/**
 * @brief Título artístico para el módulo de Carrera Futbolística
 */
#define ASCII_CARRERA                                                                              \
    "   ____    _    ____  ____  _____ ____      _      _____ _   _ _____ ____ "                   \
    "  ___  _     ___ ____ _____ ___ ____    _    \n"                                              \
    ...
    "\\___/  |_| |____/ \\___/|_____|___|____/ |_| |___\\____/_/   \\_\\\n"                        \
    "                                                                          "                   \
    "                                             \n"

/**
 * @brief Título artístico para el Dashboard principal
 */
#define ASCII_DASHBOARD                                                                            \
    "  ____            _     _                         _ \n"                                       \
...
/**
 * @brief Título artístico para el módulo de Calendario
 */
#define ASCII_CALENDARIO                                                                           \
    "   ____      _                _            _       \n"                                        \
    "  / ___|__ _| | ___ _ __   __| | __ _ _ __(_) ___  \n"                                        \
    " | |   / _` | |/ _ \\ '_ \\ / _` |/ _` | '__| |/ _ \\\n"                                      \
    " | |__| (_| | |  __/ | | | (_| | (_| | |  | | (_) |\n"                                        \
...
/**
 * @brief Título artístico para el módulo de Música
 */
#define ASCII_MUSICA                                                                               \
    "  __  __           _           \n"                                                            \
    " |  \\/  |_   _ ___(_) ___ __ _  \n"                                                          \
...
/**                                                                                                \
 * @brief Título artístico para el módulo de Tiendas                                            \
 */                                                                                                \
#define ASCII_TIENDAS                                                                              \
    "  _____  _                _           \n"                                                     \
    " |_   _|(_) ___  _ __   __| | __ _ ___ \n"                                                    \
    "   | |  | |/ _ \\| '_ \\ / _` |/ _` / __|\n"                                                  \
    "   | |  | |  __/| | | | (_| | (_| \\__ \\\n"                                                  \
...
/**
 * @brief Título artístico para el módulo de Metas
 */
#define ASCII_METAS                                                                                \
    " __  __      _            \n"                                                                 \
    "|  \\/  | ___| |_ __ _ ___ \n"                                                                \
...
/**
 * @brief Título artístico para el módulo de Botines
 */
#define ASCII_BOTINES                                                                              \
    " ____        _   _                 \n"                                                         \
...
/**
 * @brief Título artístico para el módulo de Records & Rankings
 */
#define ASCII_RECORDS_RANKINGS                                                                     \
    " ____                        _     \n"                                                         \
...
/**
 * @brief Título artístico para el módulo de Reclutamiento
 */
#define ASCII_RECLUTAMIENTO                                                                        \
    " ____           _       _                  _            _        \n"                           \
    "|  _ \\ ___  ___| |_   _| |_ __ _ _ __ ___ (_) ___ _ __ | |_ ___  \n"                         \
    "| |_) / _ \\/ __| | | | | __/ _` | '_ ` _ \\| |/ _ \\ '_ \\| __/ _ \\ \n"                     \
    "|  _ <  __/ (__| | |_| | || (_| | | | | | | |  __/ | | | || (_) |\n"                          \
    "|_| \\_\\___|\\___|_|\\__,_|\\__\\__,_|_| |_| |_|_|\\___|_| |_|\\__\\___/ \n"

/**
 * @brief Título artístico para el módulo de Referencias Multimedia
 */
#define ASCII_MEDIA                                                                                \
    " __  __       _ _   _                    _ _       \n"                                        \
